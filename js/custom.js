...
$(function () {
    ...
    var sections = $('section'),
        ...
        typed = new Typed('.type', {
            strings: ["Postdoctoral researcher."], /* Here Type Your Title */
            typeSpeed: 100,
            loop: false,
            backDelay: 1200,
            backSpeed: 10
    ...
    // action a press on the home screen - about
    $("#home-about").on("click", function () {
        $("#about-btn").click();
    });
    
    // action a press on the home screen - cv
    $("#home-cv").on("click", function () {
        $("#cv-btn").click();
    });
    ...
    $('.publications .shuffle ul li').on('click', function () {
